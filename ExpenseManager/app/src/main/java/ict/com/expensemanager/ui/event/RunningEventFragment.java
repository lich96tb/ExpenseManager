...
public class RunningEventFragment extends Fragment implements IDataBack {
    @BindView(R.id.recycler_view_running_event)
    RecyclerView recyclerViewRunningEvent;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_running_event, container, false);
    ...
    private void initialize() {
        ...
        recyclerViewRunningEvent.setLayoutManager(llm);
   ...
   class updateData extends AsyncTask<Void, List<Event>, List<Event>> {

        @Override
        protected List<Event> doInBackground(Void... voids) {
            eventList = db.eventDao().getEventsStarting(idUser);
            Collections.reverse(eventList);
            Log.d("test running event", "doInBackground: "+ eventList.size());
            return eventList;
        }
        ...
        protected void onPostExecute(List<Event> events) {
            ...
            eventAdapter.setDataBack(RunningEventFragment.this);
            recyclerViewRunningEvent.setAdapter(eventAdapter);
        }
    }
